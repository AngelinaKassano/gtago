...
export default function Gta6News() {
    ...
    <div className="max-w-6xl mx-auto px-4 py-12 grid grid-cols-1 lg:grid-cols-3 gap-8">
      ...
      <main className="lg:col-span-2 space-y-8">
        ...
        <article className="card bg-bg-card rounded-2xl p-8 border border-border shadow-lg">
          <h1 className="text-3xl font-bold mb-4">Rockstar показала первый геймплей GTA 6</h1>
          <p className="text-muted-foreground mb-6">
            14 октября 2024 • Автор: Анна Петрова
          </p>
          <img
            src="/assets/img/news/gta6.png"
            alt="GTA 6 — первый геймплей"
            className="w-full h-64 object-cover rounded-xl mb-6"
          />
          <div className="prose prose-invert prose-lg max-w-none">
            <p>
              Вчера состоялась долгожданная презентация геймплея Grand Theft Auto VI. На видео показали Вайс-Сити, новых героев и систему взаимодействия с NPC. Игра выйдет зимой 2025 года на PS5 и Xbox Series X|S.
            </p>
            <p>
          ...
          <div className="tags flex flex-wrap gap-2 mt-6">
            {['экшен', 'Rockstar', 'открытый мир'].map((tag) => (
              <span
                key={tag}
